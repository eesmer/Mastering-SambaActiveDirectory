...
<br>
Named after the file and printer sharing protocol SMB, Samba has become a great tool for us thanks to the outstanding work of [Andrew Triggel](https://www.samba.org/~tridge/) and the [Samba Team](https://www.samba.org/samba/team/). <br>
