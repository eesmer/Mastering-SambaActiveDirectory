...
Samba, named after the file and printer sharing protocol SMB, has become a great tool for us thanks to the outstanding work of [Andrew Triggel](https://www.samba.org/~tridge/) and the [Samba Team](https://www.samba.org/samba/team/)
...
- ### Schema
This defines the object types and their properties that are shared at the forest level and used in all domain environments. <br>
...
The schema basically contains 3 objects; <br>
